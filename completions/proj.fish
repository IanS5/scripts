...
complete -c proj -f -n "__ians5_proj_has_project; and not __ians5_proj_cursor_on_template" -a "(proj -lP)"
complete -c proj -f -n "__ians5_proj_has_template; or __ians5_proj_cursor_on_template" -a "(proj -lT)"
